                            ...
                            <?php
                                ...
                                if ($ris->num_rows == 0) {
                                    ...
                                    foreach($ris as $riga){
                                        ...
                                        echo '<div class="craft__card">
                                            <div class="craft__card__img">
                                                <img src="../immagini/crafting/'.$immagine.'" alt="" class="img_res">
                                            </div>
                                            
                                            <h2>'.$nome.'</h2>
                                            <p style="padding: 10px 10px">'.$materiali.'</p>
                                            </div>';
                                    }
                                    echo "</div></div>";
                                    // echo "</div>";
