                    ...
                    <div class="Global__header">
                        ...
                        <?php
                            ...
                            if(isset($_SESSION["user"])){
                                ...
                                <li class='UserInterface__menu__item' id='home'>
                                    <a href='pagine/mydata.php' class='profile_img'><img src='immagini/mobs/icons/$profile_img' alt='' style='border-radius:100%'></a>
                                </li>
                                <div class='cta'>
                ...
                <main>
                    ...
                    <div class="poster">
                        ...
                        <div class="poster__content reveal">
                            ...
                            <a href="index.php#text_before_carousel" class="button">Altri contenuti</a>
                        </div>
                    </div>
